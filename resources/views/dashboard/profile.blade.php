        ...
        <div class="relative group">
          ...
          <div class="dropdown dropdown-end">
            ...
            <label tabindex="0" class="flex items-center justify-center">
              @if($profilePhoto)
              <div class="w-32 h-32 rounded-full border-4 border-base-100 flex items-center justify-center overflow-hidden shadow-lg">
                <img src="{{ $profilePhoto }}" alt="Profile Photo" class="object-cover w-full h-full cursor-pointer">
              </div>
              @else
              <div class="avatar online placeholder">
                <div class="bg-gray-500 text-neutral-content w-32 h-32 rounded-full border-4 border-base-100 flex items-center justify-center shadow-lg">
...
<!-- Subjects Section -->
<div class="mt-8">
  <h2 class="text-xl font-bold mb-4 text-purple-600">Teaching Subjects</h2>
  <div class="flex flex-wrap gap-2">
    <span class="badge badge-lg bg-purple-100 text-purple-600 border-0">Mathematics</span>
    <span class="badge badge-lg bg-teal-100 text-teal-600 border-0">Physics</span>
    <span class="badge badge-lg bg-purple-200 text-purple-700 border-0">Calculus</span>
  </div>
</div>
