    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols- md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <a href="/o-nama" class="link link-hover">O nama</a>
          <a href="/kontakt" class="link link-hover">Kontakt</a>
          <a href="/faq" class="link link-hover">FAQ</a>
          <a href="/uvjeti-koristenja" class="link link-hover">Uvjeti korištenja</a>
        </div>
        ...
        <div>
          ...
          <p class="text-sm">Email: info@salabahter.hr</p>
          <p class="text-sm">Telefon: +385 1 2345 678</p>
          <p class="text-sm">Adresa: Ul. Ivana Gundulića 22, Zagreb</p>
        </div>
      </div>
